...
* The code generated by the storyboard templates won't work with your current code base. We've provided an explanation with steps for these changes in the [migration guide](https://github.com/SwiftGen/templates/blob/master/Documentation/MigrationGuide.md#functionality-changes-in-20-swiftgen-50), and also provided a [compatibility template](https://github.com/SwiftGen/templates/wiki/SwiftGen-5.0-Migration:-compatibility-template) in the wiki. 
